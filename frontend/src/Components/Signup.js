...
export default class SignUp extends Component {
    ...
    onSubmit = (e) => {
        ...
        axios.post("http://127.0.0.1:5000/signup",signupDetails)
            .then(response => {
                    ...
                    <form onSubmit={this.onSubmit}>
                        ...
                        <div className="form-group ">
                            <div className="input-group ">
                                ...
                                <input type="text" className="form-control" name="user_name" placeholder="Name" required="required" onChange={this.onChange} />
                            </div>
                        </div>
                        <div className="form-group">
                            <div className="input-group">
